...
class VectorStore:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2", collection_name: str = "contract_clauses"):
...
def index_clauses(clauses: List[str], metadatas: Optional[List[dict]] = None) -> List[str]:
