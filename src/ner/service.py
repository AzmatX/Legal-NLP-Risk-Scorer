...
class NERProcessor:
    ...
    def extract_entities(
        self, text: str, entity_types: set[str] | None = None, include_metadata: bool = True
    ) -> list[dict[str, Any]]:
        """
    ...
    def get_entity_summary(self, text: str, deduplicate: bool = True) -> dict[str, list[str]]:
        """
    ...
    def process_batch(
        self, texts: list[str], entity_types: set[str] | None = None
